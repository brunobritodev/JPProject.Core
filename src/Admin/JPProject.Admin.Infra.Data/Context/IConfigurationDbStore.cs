...
namespace JPProject.Admin.Infra.Data.Context
{
    ...
    public interface IConfigurationDbStore : IJpEntityFrameworkStore, IConfigurationDbContext
    {
    ...
    /// </summary>
    /// <typeparam name="TEntity"></typeparam>
    public interface IPersistedGrantDbStore : IJpEntityFrameworkStore, IPersistedGrantDbContext
    {
