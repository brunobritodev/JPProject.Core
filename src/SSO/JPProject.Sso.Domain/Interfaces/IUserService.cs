...
namespace JPProject.Sso.Domain.Interfaces
{
    ...
    {
        Task<string> CreateUserWithPass(IDomainUser user, string password);
        Task<string> CreateUserWithProvider(IDomainUser user, string provider, string providerUserId);
        Task<string> CreateUserWithProviderAndPass(IDomainUser user, string password, string provider, string providerId);
